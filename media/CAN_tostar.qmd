...
title: "Toronto Star"
name: "Toronto Star"
image: img/CAN_tostar.jpg
bibliography: biblio/CAN_tostar.bib
nocite: '@*'
csl: geo.csl
categories: 
- Pure player
...
png("img/CAN_tostar_salience.png",width = 1000, height=1000)
...
- Website : [Toronto Star](https://www.thestar.com/)
