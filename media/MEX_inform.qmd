...
title: "El Informador"
name: "El Informador"
image: img/MEX_inform.jpg
bibliography: biblio/MEX_inform.bib
nocite: '@*'
csl: geo.csl
categories: 
- Pure player
...
png("img/MEX_inform_salience.png",width = 1000, height=1000)
...
- Website : [El Informador](https://www.informador.mx)
