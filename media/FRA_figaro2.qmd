...
title: "Le Figaro"
name: "Le Figaro"
image: img/FRA_figaro.jpg
bibliography: biblio/FRA_figaro.bib
nocite: '@*'
csl: geo.csl
about:
  id: hero-heading
...
- Link: [https://www.lefigaro.fr/](https://www.lefigaro.fr/)
...
library(tidyr)
media<-"FRA_figaro"
hc<-readRDS(paste0("../sirius_sup/",media,"/hc_int.RDS")) %>%  filter(where1 !=substr(media,1,3))
nbnews<-sum(hc$news)
...
![](img/FRA_figaro_salience.png)


## Specialisation index

![](img/FRA_figaro_specialisation.png)
