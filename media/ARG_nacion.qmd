...
title: "La Nacion"
name: "La Nacion"
image: img/ARG_nacion.jpg
bibliography: biblio/ARG_nacion.bib
nocite: '@*'
csl: geo.csl
categories: 
- Pure player
...
png("img/ARG_nacion_salience.png",width = 1000, height=1000)
...
hc<-hc %>% filter(when >= as.Date("2013-07-01"),
                  when < as.Date("2021-06-30")
)
...
- Website : [La Nacion](https://www.lanacion.com.ar/)
