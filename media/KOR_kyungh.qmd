---
title: "Kyunghyang Shinmun"
name: "Kyunghyang Shinmun"
image: img/KOR_kyungh.jpg
bibliography: biblio/KOR_kyungh.bib
nocite: '@*'
csl: geo.csl
categories: 
- Pure player
...
library(mapsf)
media<-"KOR_kyungh"
hc<-readRDS(paste0("../sirius/",media,"/hc_int.RDS")) %>%  filter(! where1 %in% c("KOR"))
nbnews<-sum(hc$news)
...
cart<-cartogram_dorling(x=wld2,weight="sal",k = 1.5)
png("img/KOR_kyungh_salience.png",width = 1000, height=1000)
...
- Website : [Kyunghyang Shinmun](https://www.khan.co.kr/)
