...
image: img/KEN_standa.jpg
bibliography: biblio/KEN_standa.bib
nocite: '@*'
csl: geo.csl
categories: 
- Pure player
...
png("img/KEN_standa_salience.png",width = 1000, height=1000)
...
- Website : [The Standard (Kenya)](https://www.standardmedia.co.ke/)
