...
title: "O Globo"
name: "O Globo"
image: img/BRA_oglobo.jpg
bibliography: biblio/BRA_oglobo.bib
nocite: '@*'
csl: geo.csl
categories: 
- Pure player
...
png("img/BRA_oglobo_salience.png",width = 1000, height=1000)
...
- Website : [O Globo](https://oglobo.globo.com/)
