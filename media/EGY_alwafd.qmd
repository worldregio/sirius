...
title: "Al Wafd"
name: "Al Wafd"
image: img/EGY_alwafd.jpg
bibliography: biblio/EGY_alwafd.bib
nocite: '@*'
csl: geo.csl
categories: 
- Pure player
...
png("img/EGY_alwafd_salience.png",width = 1000, height=1000)
mf_map(grat, type="base", lty=3,col="lightblue")
mf_map(wld, type = "base",add=T, col="lightyellow", borde=NA)
mf_map(cart, type="base",col="red", add=T, border="white", lwd=0.4,inches = 0.01)
...
- Website : [Al Wafd](https://www.alwafd.news/)
