...
title: "Vanguard"
name: "Vanguard"
image: img/NGA_vangua.jpg
bibliography: biblio/NGA_vangua.bib
nocite: '@*'
csl: geo.csl
categories: 
- Pure player
...
png("img/NGA_vangua_salience.png",width = 1000, height=1000)
...
- Website : [Vanguard](https://www.vanguardngr.com/)
