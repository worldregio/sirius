...
title: "Repubblica"
name: "Repubblica"
image: img/ITA_repubb.jpg
bibliography: biblio/ITA_repubb.bib
nocite: '@*'
csl: geo.csl
categories: 
- Pure player
...
png("img/ITA_repubb_salience.png",width = 1000, height=1000)
...
- Website : [Repubblica](https://www.repubblica.it/)
