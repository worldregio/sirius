...
name: "Jerusalem Post"
image: img/ISR_jerpos.jpg
bibliography: biblio/ISR_jerpos.bib
nocite: '@*'
csl: geo.csl
categories: 
- Pure player
...
png("img/ISR_jerpos_salience.png",width = 1000, height=1000)
...
- Website : [Jerusalem Post](https://www.jpost.com/)
