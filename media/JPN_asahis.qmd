...
title: "Asahi Shimbum"
name: "Asahi Shimbum"
image: img/JPN_asahis.jpg
bibliography: biblio/JPN_asahis.bib
nocite: '@*'
csl: geo.csl
categories: 
- Pure player
...
library(mapsf)
media<-"JPN_asahis"
hc<-readRDS(paste0("../sirius/",media,"/hc_int.RDS")) %>%  filter(! where1 %in% c("JPN"))
nbnews<-sum(hc$news)
...
png("img/JPN_asahis_salience.png",width = 1000, height=1000)
...
- Website : [Asahi Shimbun](https://www.asahi.com/)
