...
name: "Time of India"
image: img/IND_tindia.jpg
bibliography: biblio/IND_tindia.bib
nocite: '@*'
csl: geo.csl
categories: 
- Pure player
...
png("img/IND_tindia_salience.png",width = 1000, height=1000)
...
- Website : [Times of India](https://timesofindia.indiatimes.com/)
