...
image: img/AUS_sydmor.jpg
bibliography: biblio/AUS_sydmor.bib
nocite: '@*'
csl: geo.csl
categories: 
- Pure player
...
png("img/AUS_sydmor_salience.png",width = 1000, height=1000)
...
- Website : [Sydney Morning Herald](https://www.smh.com.au/)
