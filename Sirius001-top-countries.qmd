...
mat3<-t(mat3)
mat3[1:3,1:3]
cor3 <- cor(mat3,use = "pairwise.complete.obs", method="spearman",)
cor3[1:3,1:3]
...
cah_euc2 <- HCPC(acp2,nb.clust = 7,method = "ward",graph = F)
...
clas <-data.frame(ISO3=rownames(x), clus11=x$clust )
wld2<-left_join(wld,clas)
mf_map(wld2, type="typo", var="clus11", pal=rainbow(9))
```
