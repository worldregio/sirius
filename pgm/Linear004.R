...
media1_name <-"The Times of India (India)"
media2_name <- "Nezavizimaya Gazeta (Russia)"
...
ggplot(tab, aes(x=dis, y=tot,label=guest)) + 
  ...
  geom_text(x = -0.97,y=0.7,label = media1_name,angle = 90)+
  geom_vline(xintercept=1,)+
  geom_text(x = 0.97,y=0.7,label = media2_name ,angle = 90)+
  geom_point()+
