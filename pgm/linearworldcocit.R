...
mod<-smacofSym(delta = Dist,type = "ordinal",ndim = 2,itmax = 10000)
mod$stress
x<-as.data.frame(mod$conf)
class(x)
plot(x$D1,x$D2,pch=20,col="blue",xlim=c(-1,1),ylim=c(-1,1),asp=1)
grid()
text(x$D1,x$D2,rownames(x),pos = 3,cex=0.7,col="red")
